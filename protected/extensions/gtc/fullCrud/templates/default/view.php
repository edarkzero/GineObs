...
$this->menu=array(
	...
	array('label'=>'<?php Yii::t('app', 'Update');?> <?php echo $this->modelClass; ?>', 'url'=>array('update', 'id'=>$model-><?php echo $this->tableSchema->primaryKey; ?>)),
	array('label'=>'<?php Yii::t('app', 'View');?> <?php echo $this->modelClass; ?>', 'url'=>'#', 'linkOptions'=>array('submit'=>array('delete','id'=>$model-><?php echo $this->tableSchema->primaryKey; ?>),'confirm'=>'Are you sure you want to delete this item?')),
	array('label'=>'<?php Yii::t('app', 'Manage');?> <?php echo $this->modelClass; ?>', 'url'=>array('admin')),
);
?>

<h1><?php echo Yii::t('app', 'View');echo $this->modelClass." #<?php echo \$model->{$this->tableSchema->primaryKey}; ?>"; ?></h1>
